...
// Multi-input metrics from BALANCED 5x10 stratified CV (196 samples, 50/50)
export const MULTI_INPUT_RESULTS = {
  ...
  cv: {
    ...
    pod_mean: 0.9818,
    pod_std: 0.0298,
    precision_mean: 0.9473,
    precision_std: 0.0447,
    f1_mean: 0.9634,
    f1_std: 0.0256,
    mcc_mean: 0.9270,
    mcc_std: 0.0519,
    accuracy_mean: 0.9623,
    accuracy_std: 0.0270,
  },
  bootstrap: {
    n_bootstrap: 1000,
    tss_mean: 0.9445,
    tss_std: 0.0462,
    tss_ci_95: [0.8387, 1.0000],
    tss_median: 0.9600,
    auc_mean: 0.9929,
    auc_std: 0.0117,
    auc_ci_95: [0.9605, 1.0000],
  },
  metrics: {
    tss: 0.9249, auc: 0.9894, hss: 0.9246, pod: 0.9818, pofd: 0.0570,
    precision: 0.9473, recall: 0.9818, f1: 0.9634, mcc: 0.9270,
    accuracy: 0.9623, balanced_accuracy: 0.9624, specificity: 0.9430,
    npv: 0.9780, fpr: 0.0570, fnr: 0.0182, brier: 0.038,
    csi: 0.930, tp: 96, fp: 5, tn: 92, fn: 2,
  },
  shap: {
    hel1os_contribution: 1.000,
    goes_contribution: 0.000,
    dominance_ratio: 99,
    top_features: [
      { feature: "hel1os_med2_flux", importance: 1.0605 },
      { feature: "hel1os_hard_soft_ratio", importance: 1.0167 },
      { feature: "hel1os_hard_std", importance: 0.9314 },
      { feature: "hel1os_med2_std", importance: 0.9147 },
      { feature: "hel1os_hard_flux", importance: 0.5217 },
    ],
  },
  physics_conclusion: "On balanced 50/50 data, HEL1OS hard X-ray spectral features (med2 band, hard/soft ratio, std) achieve TSS=0.925 ± 0.054 and AUC=0.989 ± 0.014. The instrument dominates entirely (100% SHAP contribution) — GOES soft X-ray features were below variance threshold in the balanced subset.",
};
